...
class AppWindow:
    ...
    def __init__(self, width, height):
        ...
        models.add_fixed(separation_height)
        getStatsButton = gui.Button("Get Statistics for Model")
        getStatsButton.set_on_clicked(self.getStatsButtonClicked)
    ...
    def _apply_settings(self):
        ...
        # print("Filenames: ", self.modelFilenameList)
        # print('Names:', self.modelNameList)
        # print('Dictionary Keys:', self.origionalGeometries.keys())
    ...
    def getStatsButtonClicked(self):
        pass #TODO Implement
